...
public sealed partial class MovieScript
{
    ...
    public dynamic initdrinternal()
    {
        ...
        RandomMachines_grabTiles = new LingoList { @"Machinery", @"Machinery2", @"Small machine", @"LB Machinery", @"Custom Random Machines" };
        ...
        DRBevelColors = new LingoList
        {
            new LingoList { _global.color(255, 0, 0), LingoGlobal.point(-1, -1) },
            new LingoList { _global.color(255, 0, 0), LingoGlobal.point(0, -1) },
            new LingoList { _global.color(255, 0, 0), LingoGlobal.point(-1, 0) },
            new LingoList { _global.color(0, 0, 255), LingoGlobal.point(1, 1) },
            new LingoList { _global.color(0, 0, 255), LingoGlobal.point(0, 1) },
            new LingoList { _global.color(0, 0, 255), LingoGlobal.point(1, 0) }
        };
